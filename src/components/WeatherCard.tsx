import { Box, Card, CardBody, Flex, HStack, Image, Text } from "@chakra-ui/react";
...
export const WeatherCard = ({ windDeg, iconUrl, weather, errorMessage }: WeatherCardProps) => {
    if (errorMessage) {
        return (
            <Flex w={'67%'} justifyContent="center" alignItems="center">
                <Text fontSize="2xl" color="red.500">{errorMessage}</Text>
            </Flex>
        );
    }
